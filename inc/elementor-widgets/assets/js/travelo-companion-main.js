(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".travelo-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".travelo-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".travelo-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.travelo-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.travelo-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.travelo-subscribe-newsletter-area');
    if ($subscribe.length) {
