...
/**
 *
 * Travelo elementor features section widget.
 *
 * @since 1.0
 */
class Travelo_Features extends Widget_Base {

	public function get_name() {
		return 'travelo-features';
	}

	public function get_title() {
		return __( 'App Features', 'travelo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'features_content',
			[
				'label' => __( 'Features content', 'travelo-companion' ),
			]
        );
        $this->add_control(
            'left_img',
            [
                'label' => esc_html__( 'Left Image', 'travelo-companion' ),
                'description' => esc_html__( 'Best size is 372x655', 'travelo-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Best size is 561x707', 'travelo-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Features', 'travelo-companion' ),
            ...
            'features', [
                ...
                'fields' => [
                    [
                        ...
                        'default'     => __( 'Sign Up for free', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Short Text', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default'     => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'travelo-companion' ),
                    ],
                ],
                'default'   => [
                    [      
                        'item_title'    => __( 'Sign Up for free', 'travelo-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'travelo-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Make your profile', 'travelo-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'travelo-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Enjoy the app', 'travelo-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'travelo-companion' ),
                    ],
                ]
            ]
    ...
    $left_img  = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'travelo_service_man_thumb_372x655', '', array( 'alt' => 'left image' ) ) : '';
    $right_img = !empty( $settings['right_img']['id'] ) ? wp_get_attachment_image( $settings['right_img']['id'], 'travelo_service_right_thumb_561x707', '', array( 'alt' => 'right image' ) ) : '';
