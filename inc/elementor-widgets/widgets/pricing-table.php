...
/**
 *
 * Travelo Pricing Table Contents section widget.
 *
 * @since 1.0
 */
class Travelo_Pricing_Contents extends Widget_Base {

	public function get_name() {
		return 'travelo-pricing-contents';
	}

	public function get_title() {
		return __( 'Pricing Contents', 'travelo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'pricing_content',
			[
				'label' => __( 'Pricing Contents', 'travelo-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => __( 'Unlock full Power', 'travelo-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'pricing', [
                ...
                'fields' => [
                    [
                        'name' => 'pack_name',
                        'label' => __( 'Package Name', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Basic', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'pack_price',
                        'label' => __( 'Package Price', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '$06', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'fet_1',
                        'label' => __( 'Feature 1', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'One User', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'fet_2',
                        'label' => __( 'Feature 2', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '1000 ui elements', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'fet_3',
                        'label' => __( 'Feature 3', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Webmail Support', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'fet_4',
                        'label' => __( 'Feature 4', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '100GB Cloud Storage', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'fet_5',
                        'label' => __( 'Feature 5', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Unlimited Users Limit', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'btn_label',
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Get Now', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                ...
                'default'   => [
                    [
                        'pack_name'       => __( 'Basic', 'travelo-companion' ),
                        'pack_price'      => __( '$06', 'travelo-companion' ),
                        'fet_1'           => __( 'One User', 'travelo-companion' ),
                        'fet_2'           => __( '1000 ui elements', 'travelo-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'travelo-companion' ),
                        'fet_4'           => __( '100GB Cloud Storage', 'travelo-companion' ),
                        'fet_5'           => '',
                        'btn_label'       => __( 'Get Now', 'travelo-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
                        ],
                    ],
                    [
                        'pack_name'       => __( 'Team', 'travelo-companion' ),
                        'pack_price'      => __( '$16', 'travelo-companion' ),
                        'fet_1'           => __( '10 Users', 'travelo-companion' ),
                        'fet_2'           => __( '10000 ui elements', 'travelo-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'travelo-companion' ),
                        'fet_4'           => __( '1000GB Cloud Storage', 'travelo-companion' ),
                        'fet_5'           => __( 'Unlimited Users Limit', 'travelo-companion' ),
                        'btn_label'       => __( 'Get Now', 'travelo-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
                        ],
                    ...
                    [
                        'pack_name'       => __( 'Business', 'travelo-companion' ),
                        'pack_price'      => __( '$26', 'travelo-companion' ),
                        'fet_1'           => __( 'Unlimited User', 'travelo-companion' ),
                        'fet_2'           => __( '100000 ui elements', 'travelo-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'travelo-companion' ),
                        'fet_4'           => __( '10000GB Cloud Storage', 'travelo-companion' ),
                        'fet_5'           => '',
                        'btn_label'       => __( 'Get Now', 'travelo-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
