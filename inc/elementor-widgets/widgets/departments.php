...
/**
 *
 * Travelo elementor departments section widget.
 *
 * @since 1.0
 */
class Travelo_Departments extends Widget_Base {

	public function get_name() {
		return 'travelo-departments';
	}

	public function get_title() {
		return __( 'Departments', 'travelo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'travelo-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'travelo-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'travelo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Button Text', 'travelo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Learn More', 'travelo-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'travelo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'travelo-companion' ),
                        'btn_text'   => __( 'Learn More', 'travelo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                        ],
                    ],
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'travelo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'travelo-companion' ),
                        'btn_text'   => __( 'Learn More', 'travelo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'travelo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'travelo-companion' ),
                        'btn_text'   => __( 'Learn More', 'travelo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'travelo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'travelo-companion' ),
                        'btn_text'   => __( 'Learn More', 'travelo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'travelo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'travelo-companion' ),
                        'btn_text'   => __( 'Learn More', 'travelo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'travelo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'travelo-companion' ),
                        'btn_text'   => __( 'Learn More', 'travelo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'sec_bg_col', [
                'label' => __( 'Section Bg Color', 'travelo-companion' ),
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'travelo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'travelo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'travelo_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
