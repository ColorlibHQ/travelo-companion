...
class travelo_about_widget extends WP_Widget {
...
'travelo_about_widget', 


// Widget name will appear in UI
esc_html__( '[ Travelo ] About Widget', 'travelo-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer about content', 'travelo-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'About', 'travelo-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'About Content:' ,'travelo-companion'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'travelo-companion' ); ?>:</label>
	<div class="travelo-media-container">
		<div class="travelo-media-inner">
			...
			<span class="travelo-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'travelo-companion' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="travelo-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'travelo-companion' ); ?>" class="button travelo-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'travelo-companion' ) : __( 'Select Image', 'travelo-companion' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button travelo-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
...
function travelo_about_load_widget() {
	register_widget( 'travelo_about_widget' );
}
add_action( 'widgets_init', 'travelo_about_load_widget' );