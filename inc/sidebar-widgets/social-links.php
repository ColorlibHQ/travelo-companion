...
class Travelo_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'travelo_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Travelo ] Social Links', 'travelo-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'travelo-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'travelo-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'travelo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'travelo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'travelo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'travelo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'travelo-companion'); ?></label>
...
} // Class travelo_social_links ends here


// Register and load the widget
function travelo_social_links_widget_load() {
	register_widget( 'Travelo_social_links' );
}
add_action( 'widgets_init', 'travelo_social_links_widget_load' );